...
ft_strdup:
	...
	mov rdi, rax				; Move the length of the input string to rsi
	...
	mov byte [rdi], 0			; Add the null terminator to the new string
...
malloc_fail:
	...
	call errno_location			; Call errno_location to get the address of errno
